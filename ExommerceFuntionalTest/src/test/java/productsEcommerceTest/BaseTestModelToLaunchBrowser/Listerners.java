...
import productsEcommerceTest.GlobalProperties.ExtentReportTestNG;

public class Listerners extends StandardBaseModel implements ITestListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		// TakescreenShot when the testCase is failed
